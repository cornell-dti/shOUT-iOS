...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        let pulleyViewController = PulleyViewController(contentViewController: UINavigationController(rootViewController: GoOutViewController()), drawerViewController: ReachOutViewController())
        let pulleyNav = UINavigationController(rootViewController: pulleyViewController)
        pulleyNav.isNavigationBarHidden = true
        tabBarController.addTab(index: 2, rootViewController: pulleyNav, selectedImage: #imageLiteral(resourceName: "go_out"), unselectedImage: #imageLiteral(resourceName: "go_out"))
